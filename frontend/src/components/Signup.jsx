...
const Signup = ({ setlogin,setUser }) => {
  ...
  return (
    <div className="font-[sans-serif] mt-12 invert bg-white max-w-4xl flex items-center mx-auto md:h-screen p-4">
      <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        <div className="max-md:order-1 flex flex-col justify-center md:space-y-16 space-y-8 max-md:mt-16 min-h-full bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8 px-4 py-4">
          <div>
            ...
            <p className="text-[14px] tracking-wide text-slate-300 li mt-3 leading-relaxed">
          ...
          <div>
            ...
            <p className="text-[14px] tracking-wide text-gray-300 mt-3 leading-relaxed">
